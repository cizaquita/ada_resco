    ...
    function pregunta(){
        ...
        var pregunta =  
                    [
                        ...
                        ['¿Cuantos resonadores 7 puede poner un agente?',"1 resonadore","x resxxxxxxx"],
                        ['¿Cuantos resonadores 8 puede poner un agente?',"1 resonadore","x resxxxxxxx"],
			...
			['¿Cuanto XM puede un Lawson entregarle a un Agente nivel 16?',"52800 xm","5xx00 Xx"],
                        ...
                        ['¿Que es un Link Amp?',"son mods","sxx mxxxx"],
                        ...
                        ['¿Que pasa si pongo 2 LA o SBUL?',"el primero tiene eficacia del 100% y el segundo del 25%","El prixxxx tienx una eficxxxx del x00% y el sexxxxx del xx%"],
                        ['¿Que pasa si pongo 3 LA o SBUL?',"el primero tiene eficacia del 100%, el segundo del 25% y el tercero de 12.5%","El prixxxx tienx una eficxxxx del x00%, el sexxxxx del xx% y ex tercxxx dx xx.x%"],
                        ['¿Que pasa si pongo 4 LA o SBUL?',"el primero tiene eficacia del 100%, el segundo del 25% y el tercero y cuarto de 12.5%","El prixxxx tienx una eficxxxx del x00%, el sexxxxx del xx% y ex tercxxx y cuxxxx dx xx.x%"],
                        ...
                        ['¿Cual es el rango de alcanze de un portal sin amplificadores de link y con la siguiente configuracion de resos?:'+'\n[1] [1] [1] [1] [1] [1] [1] [1]',"160 m","xx0 x"],
                        ['¿Cual es el rango de alcanze de un portal sin amplificadores de link y con la siguiente configuracion de resos?:'+'\n[8] [8] [8] [8] [8] [8] [8] [8]',"655.33 km","xxx.xx xx"],
/*                        ['¿Cual es el rango de alcanze de un portal sin amplificadores de link y con la siguiente configuracion de resos?:'+'\n[1] [1] [1] [1] [1] [1] [1] [2]',"259.29 m","xxx.xx x"],
			falta el resto sin amplificadores de link se puede cambiar por ciertos amplificadores.... este pedazo de trivia da para nmil preguntas y mendokusei hacerlas ahora algo así con cada reso por aparte formula mas arriba XDDDD y luego cada mod*/
                        ...
                        ['¿Para que son los Heat Sink?',"reducir el tiempo para volver a hackear","Redxxxx xx tiexxx pxxx volxxx x haxxxxr"],
                        ...
                        ['¿Que pasa si pongo 2 Heat Sink?',"el primero tiene eficacia del 100% y el segundo del 50%","El prixxxx tienx una eficxxxx del x00% y el sexxxxx del xx%"],
                        ['¿Que pasa si pongo 3 Heat Sink?',"el primero tiene eficacia del 100% y el segundo y tercero del 50%","El prixxxx tienx una eficxxxx del x00% y el sexxxxx y terxxxx del xx%"],
                        ['¿Que pasa si pongo 4 Heat Sink?',"el primero tiene eficacia del 100% y el segundo, tercero y cuarto del 50%","El prixxxx tienx una eficxxxx del x00% y el sexxxxx, terxxxx y cuxxxx del xx%"],
                        ...
                        ['¿Que es un Multi Hack?',"son mods","sxx mxxxx"],
                        ...
                        ['¿Que pasa si pongo 2 Multi Hack?',"el primero tiene eficacia del 100% y el segundo del 50%","El prixxxx tienx una eficxxxx del x00% y el sexxxxx del xx%"],
                        ['¿Que pasa si pongo 3 Multi Hack',"el primero tiene eficacia del 100% y el segundo y tercero del 50%","El prixxxx tienx una eficxxxx del x00% y el sexxxxx y terxxxx del xx%"],
                        ['¿Que pasa si pongo 4 Multi Hack?',"el primero tiene eficacia del 100% y el segundo, tercero y cuarto del 50%","El prixxxx tienx una eficxxxx del x00% y el sexxxxx, terxxxx y cuxxxx del xx%"],
                        ['¿Cuantos Hacks mas da un Multi Hack Común?',"4 hacks mas","x haxxx mxx"],
                        ['¿Cuantos Hacks mas da un Multi Hack Raro?',"8 hacks mas","x haxxx mxx"],
                        ['¿Cuantos Hacks mas da un Multi Hack Muy Raro?',"12 hacks mas","xx haxxx mxx"],
                        ['¿Que es un Force Amp?',"son mods","sxx mxxxx"],
                        ...
                        ['¿Que pasa si pongo 2 Force Amp?',"el primero tiene eficacia del 100% y el segundo del 25%","El prixxxx tienx una eficxxxx del x00% y el sexxxxx del xx%"],
                        ['¿Que pasa si pongo 3 Force Amp?',"el primero tiene eficacia del 100%, el segundo del 25% y el tercero de 12.5%","El prixxxx tienx una eficxxxx del x00%, el sexxxxx del xx% y ex tercxxx dx xx.x%"],
                        ['¿Que pasa si pongo 4 Force Amp?',"el primero tiene eficacia del 100%, el segundo del 25% y el tercero y cuarto de 12.5%","El prixxxx tienx una eficxxxx del x00%, el sexxxxx del xx% y ex tercxxx y cuxxxx dx xx.x%"],
                        ['¿Que es una Turret?',"son mods","sxx mxxxx"],
                        ['¿En cuanto aumenta el critico de ataque una Turret?',"20%","xx%"],
                        ...
                        ['¿Que pasa si pongo 2 Turret?',"el primero tiene eficacia del 100% y el segundo del 25%","El prixxxx tienx una eficxxxx del x00% y el sexxxxx del xx%"],
                        ['¿Que pasa si pongo 3 Turret?',"el primero tiene eficacia del 100%, el segundo del 25% y el tercero de 12.5%","El prixxxx tienx una eficxxxx del x00%, el sexxxxx del xx% y ex tercxxx dx xx.x%"],
                        ['¿Que pasa si pongo 4 Turret?',"el primero tiene eficacia del 100%, el segundo del 25% y el tercero y cuarto de 12.5%","El prixxxx tienx una eficxxxx del x00%, el sexxxxx del xx% y ex tercxxx y cuxxxx dx xx.x%"],
                        ...
                        ['¿Que es una Capsula Mufg?',"son items patrocinados","Sxx itxx paxxxxxxxxxx"],
                        ...
                        ['¿Que rango de recarga tiene un Agente nivel 1?',"250 km","xx0 xx"],
                        ['¿Que rango de recarga tiene un Agente nivel 2?',"500 km","xx0 xx"],
                        ['¿Que rango de recarga tiene un Agente nivel 3?',"750 km","xx0 xx"],
                        ['¿Que rango de recarga tiene un Agente nivel 4?',"1000 km","xxx0 xx"],
                        ['¿Que rango de recarga tiene un Agente nivel 5?',"1250 km","xxx0 xx"],
                        ['¿Que rango de recarga tiene un Agente nivel 6?',"1500 km","xxx0 xx"],
                        ['¿Que rango de recarga tiene un Agente nivel 7?',"1750 km","xxx0 xx"],
                        ['¿Que rango de recarga tiene un Agente nivel 8?',"2000 km","xxx0 xx"],
                        ['¿Que rango de recarga tiene un Agente nivel 9?',"2250 km","xxx0 xx"],
                        ['¿Que rango de recarga tiene un Agente nivel 10?',"2500 km","xxx0 xx"],
                        ['¿Que rango de recarga tiene un Agente nivel 11?',"2750 km","xxx0 xx"],
                        ['¿Que rango de recarga tiene un Agente nivel 12?',"3000 km","xxx0 xx"],
                        ['¿Que rango de recarga tiene un Agente nivel 13?',"3250 km","xxx0 xx"],
                        ['¿Que rango de recarga tiene un Agente nivel 14?',"3500 km","xxx0 xx"],
                        ['¿Que rango de recarga tiene un Agente nivel 15?',"3750 km","xxx0 xx"],
                        ['¿Que rango de recarga tiene un Agente nivel 16?',"4000 km","xxx0 xx"]
                    ];
