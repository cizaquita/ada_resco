    ...
    function pregunta(){
        ...
        var pregunta =  
                    [
                        ...
                        ['¿Que es un Ultra Strike?',"un tipo de arma que tienen un muy corto alcance pero tienen un critico de dano muy elevado","Ux tixx xx arxx xxx tixxx xx xxx cxxxx alxxxxx pxxx tixxx xx crixxxx xx dxxx xxx elexxxx"],
                        ...
                        ['¿Por qué hay portales con 8 resonadores a nombre de __ADA__?',"porque fue un sapo quien usó un ada","porque fxx xx saxx quxxx uxx xx xxx"],
                        ...
                        ['¿Por qué hay portales con 8 resonadores a nombre de __Jarvis__?',"porque fue un pitufo quien uso un jarvis","porque Fxx xx pixxxx qxxxx uxx xn xxxxxx"],
			...
			['¿Cuanto XM puede un Lawson entregarle a un Agente nivel 16?',"52800","5xx00"],
                        ...
                        ['¿Para que son los Link Amp?',"mods cuyo efecto es aumentar la distancia de linkeo","moxx cuxx efxxxo xx auxxxxx xx disxxxxxx xx lxxkxx"],
                        ...
                        ['¿Que es una Capsula de Llaves/keylocker?',"son items de pago","Sxx itxxx dx paxx"],
