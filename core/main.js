            ...
            // Subir de lvl
                ...
                /*else if(text.indexOf("trivia") > -1 || text.indexOf("preguntas") > -1 && words(text) < 5){                   
                   var mensajes =  ['¿Que es un XMP?',
                                     ...
                                     '¿Como uso mejor los XMP contra mods?',
                                     '¿Como uso mejor los XMP en farm sapo?',
                                     '¿Cual es el rango de ataque de un XMP 1?',
                                     '¿De cuanto es el critico de ataque de un XMP 1?',
                                     '¿Cual es el rango de ataque de un XMP 2?',
                                     '¿De cuanto es el critico de ataque de un XMP 2?',
                                     '¿Cual es el rango de ataque de un XMP 3?',
                                     '¿De cuanto es el critico de ataque de un XMP 3?',
                                     '¿Cual es el rango de ataque de un XMP 4?',
                                     '¿De cuanto es el critico de ataque de un XMP 4?',
                                     '¿Cual es el rango de ataque de un XMP 5?',
                                     '¿De cuanto es el critico de ataque de un XMP 5?',
                                     '¿Cual es el rango de ataque de un XMP 6?',
                                     '¿De cuanto es el critico de ataque de un XMP 6?',
                                     '¿Cual es el rango de ataque de un XMP 7?',
                                     '¿De cuanto es el critico de ataque de un XMP 7?',
                                     '¿Cual es el rango de ataque de un XMP 8?',
                                     '¿De cuanto es el critico de ataque de un XMP 8?',
                                     '¿Que es un Ultra Strike?',
                                     '¿Como uso mejor los Ultra Strike?',
                                     '¿Para que son los Ultra Strike?',
                                     '¿Cual es el rango de ataque de un US 1?',
                                     '¿De cuanto es el critico de ataque de un US 1?',
                                     '¿Cual es el rango de ataque de un US 2?',
                                     '¿De cuanto es el critico de ataque de un US 2?',
                                     '¿Cual es el rango de ataque de un US 3?',
                                     '¿De cuanto es el critico de ataque de un US 3?',
                                     '¿Cual es el rango de ataque de un US 4?',
                                     '¿De cuanto es el critico de ataque de un US 4?',
                                     '¿Cual es el rango de ataque de un US 5?',
                                     '¿De cuanto es el critico de ataque de un US 5?',
                                     '¿Cual es el rango de ataque de un US 6?',
                                     '¿De cuanto es el critico de ataque de un US 6?',
                                     '¿Cual es el rango de ataque de un US 7?',
                                     '¿De cuanto es el critico de ataque de un US 7?',
                                     '¿Cual es el rango de ataque de un US 8?',
                                     '¿De cuanto es el critico de ataque de un US 8?',
                                     '¿Que es un ADA Refactor?',
                                     '¿Como nacieron las ADA Refactor?',
                                     '¿Para que es el ADA Refactor?',
                                     '¿Como uso mejor las ADA Refactor?',
                                     '¿Cuanto XM se debe tener para usar un ADA Refactor?',
                                     '¿Cuanto XM se debe tener para usar un ADA Refactor en un portal 1?',
                                     '¿Cuanto XM se debe tener para usar un ADA Refactor en un portal 2?',
                                     '¿Cuanto XM se debe tener para usar un ADA Refactor en un portal 3?',
                                     '¿Cuanto XM se debe tener para usar un ADA Refactor en un portal 4?',
                                     '¿Cuanto XM se debe tener para usar un ADA Refactor en un portal 5?',
                                     '¿Cuanto XM se debe tener para usar un ADA Refactor en un portal 6?',
                                     '¿Cuanto XM se debe tener para usar un ADA Refactor en un portal 7?',
                                     '¿Cuanto XM se debe tener para usar un ADA Refactor en un portal 8?',
                                     '¿Por qué hay portales con 8 resonadores a nombre de un pitufo?',
                                     '¿Por qué hay portales con 8 resonadores a nombre de __ADA__?',
                                     '¿Que debo hacer si me sale un ADA Refactor?',
                                     '¿Que es un Jarvis Virus?',
                                     '¿Como nacieron los Jarvis Virus?',
                                     '¿Cuanto XM se debe tener para usar un Jarvis Virus?',
                                     '¿Cuanto XM se debe tener para usar un Jarvis Virus en un portal 1?',
                                     '¿Cuanto XM se debe tener para usar un Jarvis Virus en un portal 2?',
                                     '¿Cuanto XM se debe tener para usar un Jarvis Virus en un portal 3?',
                                     '¿Cuanto XM se debe tener para usar un Jarvis Virus en un portal 4?',
                                     '¿Cuanto XM se debe tener para usar un Jarvis Virus en un portal 5?',
                                     '¿Cuanto XM se debe tener para usar un Jarvis Virus en un portal 6?',
                                     '¿Cuanto XM se debe tener para usar un Jarvis Virus en un portal 7?',
                                     '¿Cuanto XM se debe tener para usar un Jarvis Virus en un portal 8?',
                                     '¿Por qué hay portales con 8 resonadores a nombre de un Sapo?',
                                     '¿Por qué hay portales con 8 resonadores a nombre de __Jarvis__?',
                                     '¿Como usar un Jarvis para trollear?',
                                     '¿Que debo hacer si me sale un Jarvis Virus?',
                                     '¿Como uso mejor los Jarvis Virus?',
                                     '¿Para que es el Jarvis Virus?',
                                     '¿Que es un Resonador?',
                                     '¿Cuanto XM tiene un resonador 1?',
                                     '¿Cuanto XM tiene un resonador 2?',
                                     '¿Cuanto XM tiene un resonador 3?',
                                     '¿Cuanto XM tiene un resonador 4?',
                                     '¿Cuanto XM tiene un resonador 5?',
                                     '¿Cuanto XM tiene un resonador 6?',
                                     '¿Cuanto XM tiene un resonador 7?',
                                     '¿Cuanto XM tiene un resonador 8?',
                                     '¿Cuantos resonadores 1 puede poner un agente?',
                                     '¿Cuantos resonadores 2 puede poner un agente?',
                                     '¿Cuantos resonadores 3 puede poner un agente?',
                                     '¿Cuantos resonadores 4 puede poner un agente?',
                                     '¿Cuantos resonadores 5 puede poner un agente?',
                                     '¿Cuantos resonadores 6 puede poner un agente?',
                                     '¿Cuantos resonadores 7 puede poner un agente?',
                                     '¿Cuantos resonadores 8 puede poner un agente?',
                                     '¿Para que son los Resonadores?',
                                     '¿Cual es la adherencia extra de un Resonador?',
                                     '¿Como debo poner los resonadores para maximizar defensa?',
                                     '¿Como debo poner los resonadores para hacer que un ataque combinado de XMPs y US haga que se gaste mas XM?',
                                     '¿Que es un Portal?',
                                     '¿Cuanto XM tiene un portal 1?',
                                     '¿Cuanto XM tiene un portal 2?',
                                     '¿Cuanto XM tiene un portal 3?',
                                     '¿Cuanto XM tiene un portal 4?',
                                     '¿Cuanto XM tiene un portal 5?',
                                     '¿Cuanto XM tiene un portal 6?',
                                     '¿Cuanto XM tiene un portal 7?',
                                     '¿Cuanto XM tiene un portal 8?',
                                     '¿Que es el XM?',
                                     '¿Que son los Shaper?',
                                     '¿Que son los N-Zeer?',
                                     '¿Que son los Iluminados?',
                                     '¿Que es la Resistencia?',
                                     '¿Que son los glifos?',
                                     '¿Cuales son los nuevos lideres de ambas facciones?',
                                     '¿Que son los los antiguos lideres de ambas facciones?',
                                     '¿Que hacen las anomalias con la historia y como afecta eso en el juego?',
                                     '¿Que es un Power Cube?',
                                     '¿Como nacieron los Power Cube?',
                                     '¿Para que son los Power Cube?',
                                     '¿Como hago para usar mejor los Cubos?, es decir, ¿no darle usar a cada cubo si voy a usar varios?',
                                     '¿Que es un Cubo Lawson?',
                                     '¿Que debo hacer si me sale un Cubo Lawson?',
                                     '¿Para que son los Cubo Lawson?',
                                     '¿En que casos debo usar los Cubos Lawson?',
                                     '¿Que es una Llave?',
                                     '¿Para que son las llaves?',
                                     '¿Como uso mejor las llaves?',
                                     '¿Como saber que llaves reciclar?',
                                     '¿Que debo reciclar cuando no tengo XM ni Cubos?',
                                     '¿Cuanto XM me da un item al reciclarlo?',
                                     '¿Cuanto XM me da un item nivel 1 al reciclarlo?',
                                     '¿Cuanto XM me da un item nivel 2 al reciclarlo?',
                                     '¿Cuanto XM me da un item nivel 3 al reciclarlo?',
                                     '¿Cuanto XM me da un item nivel 4 al reciclarlo?',
                                     '¿Cuanto XM me da un item nivel 5 al reciclarlo?',
                                     '¿Cuanto XM me da un item nivel 6 al reciclarlo?',
                                     '¿Cuanto XM me da un item nivel 7 al reciclarlo?',
                                     '¿Cuanto XM me da un item nivel 8 al reciclarlo?',
                                     '¿Cuanto XM me da un item común al reciclarlo?',
                                     '¿Cuanto XM me da un item raro al reciclarlo?',
                                     '¿Cuanto XM me da un item muy raro al reciclarlo?',
                                     '¿Cuanto XM me da una llave al reciclarla?',
                                     '¿Que es un Mod?',
                                     '¿Que items tienen adherencia extra?',
                                     '¿Para que son los Mod?',
                                     '¿Como uso mejor los mods?',
                                     '¿Cuantos mods puede poner un Agente?',
                                     '¿Que es un Escudo?',
                                     '¿Para que son los Escudos?',
                                     '¿Como uso mejor los Escudos?',
                                     '¿Cual es la adherencia extra de un Escudo Común?',
                                     '¿Cual es la adherencia extra de un Escudo Raro?',
                                     '¿Cual es la adherencia extra de un Escudo Muy Raro?',
                                     '¿Cual es la adherencia extra de un AXXA?',
                                     '¿Cual es la mitigación de ataque de un Escudo Común?',
                                     '¿Cual es la mitigación de ataque de un Escudo Raro?',
                                     '¿Cual es la mitigación de ataque de un Escudo Muy Raro?',
                                     '¿Cual es la mitigación de ataque de un AXXA?',
                                     '¿Que es un AXA?',
                                     '¿Que debo hacer si me sale un AXA?',
                                     '¿Para que son los AXA?',
                                     '¿Como uso mejor los AXA?',
